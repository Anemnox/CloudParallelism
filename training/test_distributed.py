...
#    {"instance_count": 4, "epochs": 2},
#    {"instance_count": 8, "epochs": 2}
]
    ...
    estimator = PyTorch(
        ...
        hyperparameters={
            ...
            "per_device_train_batch_size": (
                ...
                "per_device_train_batch_size" in config else 2),
        ...
        "NCCL_IB_DISABLE": "0",  # Change to "1" if InfiniBand is unavailable
        "NCCL_P2P_DISABLE": "0",
        },
